...
func inventoryForWindows() (payload.Inventory, error) {
...
func inventoryForLinux() (payload.Inventory, error) {
	// Implementación específica para Linux
	return payload.Inventory{}, nil
}

func inventoryForDarwin() (payload.Inventory, error) {
...
func Inventory() (payload.Inventory, error) {
	...
	switch runtime.GOOS {
	case "windows":
		inventory, err = inventoryForWindows()
	case "linux":
		inventory, err = inventoryForLinux()
	case "darwin":
		inventory, err = inventoryForDarwin()
	}
